    ...
    <div class="flex flex-col h-auto w-screen">
      ...
      <div class="flex flex-col h-screen bg-theme-blue shadow-xl shadow-dark-blue">
        ...
        <div class="w-full h-2/3 flex justify-center items-center">
          <button onClick={handleBeginFlow} class="w-1/3 h-[80px] relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-theme-blue transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 group">
