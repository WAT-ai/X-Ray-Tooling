...
const HomePage = () => {
  ...
  return (
    <div class="flex flex-col h-auto w-screen">
      ...
      <div class="flex flex-col h-screen bg-theme-blue shadow-xl shadow-dark-blue">
        <div class="flex flex-col sm:flex-row w-full ">
          <div class="h-full w-full sm:w-7/12 flex flex-col items-center sm:items-auto">
            <div class="w-5/6 sm:w-full flex flex-col ml-0 sm:ml-20 mt-20">
              <h1 class="text-left text-3xl sm:text-5xl font-bold text-white">Real time X-ray diagnosis and consultation</h1>
              <h1 class="text-left text-3xl sm:text-5xl font-bold bg-clip-text" style={{ color: '#D1F5EE' }}>
                —without the hassle
              </h1>
            </div>
            <div class="w-full h-1/2 flex justify-start items-center sm:items-start sm:justify-start text-bold flex-col mt-10 sm:mt-20">
      ...
      <div class="w-full h-auto grid grid-cols-1 breakpoint-1000:grid-cols-2 items-start my-10 sm:my-20">
        <div class="w-full flex justify-center breakpoint-1000:justify-end items-center my-20">
          <div class=" h-2/3 w-3/4 breakpoint-1000:mr-20">
            <div class="flex flex-col">
              <div class="flex flex-row items-center">
                <div class="w-14 h-14 sm:w-28 sm:h-28 bg-blue-500 rounded-full flex justify-center items-center">
                  <FileUploadOutlinedIcon sx={{fontSize: '6vh',color: 'white' }} />
                </div>
        ...
        <div class="flex justify-center items-center breakpoint-1000:my-20">
          <div class="w-5/6 h-full justify-center items-center">
            <img class="h-2/3 px-10" src={photoCollage} />
          </div>
        </div>
      </div>
      <div class="w-full h-auto grid grid-cols-1 justify-center items-start my-10 sm:my-20 breakpoint-1000:grid-cols-12 breakpoint-1000:grid-rows-1 grid-rows-2 grid-flow-col">
        <div class="h-full flex justify-center col-span-1 md:col-span-7 breakpoint-1000:my-20 breakpoint-1000:order-1 order-2">
          <div class="w-5/6 h-full justify-center items-center">
            <img src={diagnosisDemo} />
          </div>
        </div>
        <div class="col-span-1 breakpoint-1000:col-span-5 justify-center flex breakpoint-1000:items-center my-10 breakpoint-1000:my-20 breakpoint-1000:order-2 order-1 justify-end">
          <div class="h-2/3 w-3/4 flex items-center breakpoint-1000:mr-20">
            <div class="flex flex-col">
              <div class="flex flex-row items-center">
                <div class="w-14 h-14 sm:w-28 sm:h-28 bg-blue-500 rounded-full flex justify-center items-center">
                  <TroubleshootIcon sx={{fontSize: '6vh',color: 'white' }} />
                </div>
      ...
      <div class="w-full h-auto grid grid-cols-1 breakpoint-1000:grid-cols-2 items-start my-10 sm:my-20">
        <div class="w-full flex justify-center breakpoint-1000:justify-end items-center my-20 breakpoint-1000:order-1 order-1">
          <div class="h-2/3 w-3/4 breakpoint-1000:mr-20">
            <div class="flex flex-col">
              <div class="flex flex-row items-center">
                <div class="w-14 h-14 sm:w-28 sm:h-28 bg-blue-500 rounded-full flex justify-center items-center">
                  <QuestionAnswerIcon sx={{fontSize: '6vh',color: 'white' }} />
                </div>
        ...
        <div class="flex justify-center items-center breakpoint-1000:my-20 breakpoint-1000:order-2 order-2">
